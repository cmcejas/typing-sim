...
wpm_slider = ctk.CTkSlider(sidebar_frame, from_=10, to=120, command=update_wpm_parameters, button_color=accent_color, progress_color=accent_color, button_hover_color=second_color)  # WPM slider
...
# Error Slider
error_slider = ctk.CTkSlider(sidebar_frame, from_=0, to=30, command=update_error_rate_label, button_color=accent_color, progress_color=accent_color, button_hover_color=second_color)  # Update label on slider change
error_slider.set(10)
...
title_card = ctk.CTkLabel(scrollable_frame, text="Typing Simulator", font=("Arial", 24, "bold"), fg_color=accent_color, text_color="black", width=800, height=50, corner_radius=10)
...
# Upload File Button
upload_button = ctk.CTkButton(scrollable_frame, text="Upload File", command=upload_file, fg_color=accent_color, text_color="black", hover_color=second_color)
upload_button.pack(pady=5)

# Text input area
text_area = ctk.CTkTextbox(scrollable_frame, height=200, width=400, border_color=accent_color, border_width=2)
text_area.pack(pady=10)

# Start Button
start_button = ctk.CTkButton(scrollable_frame, text="Start Typing", command=start_typing, fg_color=accent_color, text_color="black", hover_color=second_color)
start_button.pack(pady=5)

# Stop Button
stop_button = ctk.CTkButton(scrollable_frame, text="Stop Typing", command=stop_typing_function, fg_color=accent_color, text_color="black", hover_color=second_color)
...
hamburger_button = ctk.CTkButton(
    ...
    corner_radius=10, 
    hover_color=second_color  # Optional: Set corner radius for rounded corners
)
